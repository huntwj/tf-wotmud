...
/eval /def -mregexp -h'PROMPT ^([*o] (R )?HP:(%{wot_health_states})( SP:(%{wot_spell_states}))? MV:(%{wot_movement_states})(( - (.*): (%{wot_health_states}))? - (.*): (%{wot_health_states}))? > )' wot_prompt_trigger = \
    /wot_do_prompt
